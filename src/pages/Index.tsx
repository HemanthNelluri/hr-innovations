  ...
  return (
    <div className="min-h-screen bg-white relative">
      <div className="relative z-10">
        ...
        <div className="absolute top-1/8 left-1/3 transform -translate-x-142 -translate-y-1/4 opacity-20 pointer-events-none bg-gradient-to-br from-[#1A1F2C]/40 to-[#8B5CF6]/40 backdrop-blur-md rounde[...]
          <motion.img 
